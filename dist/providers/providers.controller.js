...
let ProvidersController = class ProvidersController {
    ...
    search(body) {
        return this.providersService.searchProviders(body.serviceType, body.lat, body.lng);
    }
    getById(id) {
    ...
    updateLocation(body, req) {
        return this.providersService.updateLocation(req.user.sub, body.lat, body.lng);
    }
};
